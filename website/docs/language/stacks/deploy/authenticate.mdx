...
For example, if your `test` deployment can use your `store` to access your variable set’s keys, it will have access to, and be able to work with, your variable set’s AWS provider credentials.  
